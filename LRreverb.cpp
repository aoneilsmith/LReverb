...
*/
bool __stdcall CLRreverb::initialize()
{
	// Add your code here
...
*/
bool __stdcall CLRreverb::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall CLRreverb::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	else if(m_uFXonoff==FXin)
	{
	float xn = pInputBuffer[0]* m_fGain;
	float yn = ((pInputBuffer[1] - pInputBuffer[0])*m_fGain) * (((3.0*xn)/2.0) * ( 1.0 - (xn*xn)/3.0));
...

	{
		...
		else if  ( pInputBuffer[1] >=1)// m_uFXonoff==FXin)
		{
			float xn = pInputBuffer[1]*m_fGain;
			float yn = ((pInputBuffer[0] - pInputBuffer[1])*m_fGain) * (((3.0*xn)/2.0) * ( 1.0 - (xn*xn)/3.0));
		...
		{
			float xn = pInputBuffer[1]*m_fGainMinus;
			float yn = ((pInputBuffer[0] - pInputBuffer[1])*m_fGainMinus) * (((3.0*xn)/2.0) * ( 1.0 - (xn*xn)/3.0));
...
//
bool __stdcall CLRreverb::userInterfaceChange(int nControlIndex)
{

		char* mess1="userInterfaceChange() call with ID: ";
	char* index = intToString(nControlIndex);

	char* finalMess = addStrings(mess1, index);

	sendStatusWndText(finalMess);
...
*/
bool __stdcall CLRreverb::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CLRreverb::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CLRreverb::processVSTAudioBuffer(float** ppInputs, float** ppOutputs,
...
bool __stdcall CLRreverb::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CLRreverb::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CLRreverb::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CLRreverb::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CLRreverb::midiClock()
{
...
bool __stdcall CLRreverb::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CLRreverb::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui0.fUserDisplayDataHiLimit = 2.000000;
	ui0.uUserDataType = floatData;
	ui0.fInitUserIntValue = 0;
	ui0.fInitUserFloatValue = 1.000000;
	ui0.fInitUserDoubleValue = 0;
	ui0.fInitUserUINTValue = 0;
	ui0.m_pUserCookedIntData = NULL;
	ui0.m_pUserCookedFloatData = &m_fGain;
	ui0.m_pUserCookedDoubleData = NULL;
	ui0.m_pUserCookedUINTData = NULL;
	ui0.cControlUnits = "Units                                                           ";
	ui0.cVariableName = "m_fGain";
	ui0.cEnumeratedList = "FXin,Fxout";
	ui0.dPresetData[0] = 1.000000;ui0.dPresetData[1] = 0.000000;ui0.dPresetData[2] = 0.000000;ui0.dPresetData[3] = 0.000000;ui0.dPresetData[4] = 0.000000;ui0.dPresetData[5] = 0.000000;ui0.dPresetData[6] = 0.000000;ui0.dPresetData[7] = 0.000000;ui0.dPresetData[8] = 0.000000;ui0.dPresetData[9] = 0.000000;ui0.dPresetData[10] = 0.000000;ui0.dPresetData[11] = 0.000000;ui0.dPresetData[12] = 0.000000;ui0.dPresetData[13] = 0.000000;ui0.dPresetData[14] = 0.000000;ui0.dPresetData[15] = 0.000000;
	ui0.cControlName = "Gain [L]";
	...
	ui2.m_pUserCookedUINTData = &m_uFXonoff;
	ui2.cControlUnits = "";
	ui2.cVariableName = "m_uFXonoff";
	ui2.cEnumeratedList = "FXin,FXout";
